...
function Project({ props }) {
  return (
    <div className="w-full bg-white border border-gray-200 shadow-sm dark:bg-[#18232c] p-3 rounded-[8px] custom-shadow dark:shadow-md border-solid dark:border-[#11191f]">
