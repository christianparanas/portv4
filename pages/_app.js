...
function MyApp({ Component, pageProps }) {
  return (
    ...
    <Head>
        ...
        <meta
          name='description'
          content='Hi, I am Christian Paranas a web development enthusiast that is armed with experience, learning, and passion.'
        />
        <meta
          name='thumbnail'
          content='https://christianparanas.vercel.app/me.png'
        />
        <meta
          property='og:title'
          content='Christian Paranas | Web Developer'
        />
        <meta property='og:site_name' content='Christian Paranas' />
        <meta
          name='keywords'
          content='Web developer, Frontend developer, Backend developer'
        />{' '}
        <meta
          name='thumbnail'
          content='https://christianparanas.vercel.app/me.png'
